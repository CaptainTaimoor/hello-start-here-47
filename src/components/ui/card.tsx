  ...
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        "bg-[linear-gradient(180deg,color-mix(in_oklab,white_3%,transparent),transparent_60%),color-mix(in_oklab,var(--card)_92%,transparent)]",
        "shadow-[0_1px_0_0_rgb(255_255_255/0.06)_inset,0_20px_50px_-30px_rgb(0_0_0/0.55)]",
